...
@section('content')
    ...
    <div  class="max-h-screen overflow-y-auto c-bg-customBackground">
        <div class="p-4  flex justify-between c-bg-customBackground items-center mt-10">
            <h2 class="text-lg font-bold c-text-blue">Crear Factura</h2>
            <x-buttons.route class="mr-4" route="admin.invoice.index" content="Atras"></x-buttons.route>
        </div>
        <div class=" mx-2  px-4 py-3 mb-8 overflow-x-auto c-bg-gray rounded-lg shadow-md dark:bg-gray-800">
            <form  class="">
                ...
                <div class="md:flex md:items-center mb-4">
                    ...
                    <div class="md:w-1/2 pr-0 md:pr-4 mb-4 md:mb-0 md:mr-4">
                        <label for="countries" class="block c-text-blue font-bold mb-2">Orden de servicio*:</label>
                        <select wire:model.lazy="roleId" id="" name="roleId" class="mb-2 bg-gray-300 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option value="">Seleccionar rol</option>
                        </select>
                        <div class="h-4">
                    ...
                    <div class="md:w-1/2 pr-0 md:pr-4 mb-4 md:mb-0 ">
                        <label for="countries" class="block c-text-blue font-bold mb-2">Impuesto:</label>
                        <input type="checkbox" class="h-6 w-6 text-blue-600 bg-gray-200 rounded border-gray-300 focus:ring-blue-500 focus:ring-2 transition duration-200">
                    </div>
                ...
                <div class="md:flex md:items-center mb-4">
                    <div class="md:w-full">
                        <label for="name" class="block c-text-blue font-bold mb-2">Observaciones*:</label>
                        <textarea
