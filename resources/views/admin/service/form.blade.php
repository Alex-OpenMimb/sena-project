...
@section('content')
    ...
    <div  class="max-h-screen overflow-y-auto c-bg-customBackground">
        <div class="p-4  flex justify-between c-bg-customBackground items-center mt-10">
            <h2 class="text-lg font-bold c-text-blue">Crear Servicios</h2>
            <x-buttons.route class="mr-4" route="admin.service.index" content="Atras"></x-buttons.route>
        </div>
            ...
            <form  class="">
                <div class="md:flex  md:items-center mb-4">
                    ...
                    <div class="md:w-1/2">
                        ...
                        <div class="md:w-1/2 pr-0 md:pr-4 mb-4 md:mb-0">
                            <label for="email" class="block c-text-blue font-bold mb-2">Estado*:</label>
                        ...
                        <div class="md:w-1/2 pr-0 md:pr-4 mb-4 ">
                            <label for="phone" class="block c-text-blue font-bold mb-2">Precio hora:</label>
                            <input   type="number" id="" name="phone" class="focus:outline-none bg-gray-300 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500  mb-2">
